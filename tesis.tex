...
%                                   DATOS                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{ DESARROLLO DE UN SISTEMA DE ALTO VOLTAJE PARA ACELERADORES DE PARTICULAS}
...
\begin{document}
\begin{center}
{\Large Universidad Autónoma de Sinaloa}
...
Dr. Christian Valerio Lizarraga\\
\end{normalsize}


\setlength{\parskip}{60pt}
Culiacán, Sinaloa, 2018
\end{center}
