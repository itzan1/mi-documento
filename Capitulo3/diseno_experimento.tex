...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{Capitulo3/figs/noimagen.png}
\caption{Multiplicador de voltaje sin carga}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{Capitulo3/figs/exfuente.png}
\caption{Arreglo para experimento de fuente de 12V}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=9cm]{Capitulo3/figs/sincarga.png}
\caption{Fuente 12V sin carga}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=9cm]{Capitulo3/figs/75ohms.png}
\caption{Fuente 12V con carga a 7.5 OHMS}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=9cm]{Capitulo3/figs/15ohms.png}
...
Este modulo ha sido aislado de la misma manera que se aisló la fuente de 180W (figura XXX) debido a los riesgos que conlleva si no se tiene el cuidado pertinente. Ahora implementando la fuente desarrollada por nosotros se alimenta al inversor y se hace un arreglo similar al experimento anterior, analizando en el osciloscopio la salida sin carga, con cargas de 15 OHMS y de 7.5 OHMS, variando en este caso la frecuencia de salida.
